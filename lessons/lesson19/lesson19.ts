// type alias
type hNamType = number | string | boolean | object;

function addTwoNumbersOrString(a: hNamType, b: number | string) {
...
console.log(">>> Check: ", addTwoNumbersOrString("eric", " Hoai Nam"));
